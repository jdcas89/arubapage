        ...
        <div className="jumbotron">
            <section className="jumbotron text-center">
                <div className="container">
                    ...
                    The idea started when one frustrated and unhappy Aruban had to either bookmark all news providers 
                    and daily opening them one by one to read the latest news. Knowing that Aruba is a one happy Island, this 
                    Aruban was determined to remove this hassle to chase after news and be happy with not having to open
                    ...
                    optimize the site for a better user experience.<br /><br/>

                    So far we had a few really interesting feedback from our users. Your feedback is important to us, feel free to reach us on Facebook, Twitter, Instagram or simply send us an email at: info@arubapage.com 
